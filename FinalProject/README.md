...
#3.5 Arranges the combobox frame.
#3.5.1 Add labels, comboboxes and the get button to the frame.
...
#3.5.2 Set default selection.
period_combobox.current(0)
interval_combobox.current(0)

#3.5.3 Define the frame layout
...
#3.6 Arrange the button frame.
#3.6.1 Adds a button to the button frame.
...
#3.6.2 Defines the frame layout.
get_button.pack()

#3.7 Arrange the treeview frame.
#3.7.1 Adds a treeview to the treeview frame.
